...
public class Lua_UnityEngine_Light : LuaObject {
	...
	static public int AddCommandBuffer(IntPtr l) {
		try {
			...
			if(argc==3){
				...
				a1 = (UnityEngine.Rendering.LightEvent)LuaDLL.luaL_checkinteger(l, 2);
				...
				a3 = (UnityEngine.Rendering.ShadowMapPass)LuaDLL.luaL_checkinteger(l, 4);
	...
	static public int GetLights_s(IntPtr l) {
		try {
			...
			a1 = (UnityEngine.LightType)LuaDLL.luaL_checkinteger(l, 1);
			System.Int32 a2;
	...
	static public int set_shadows(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightShadows)LuaDLL.luaL_checkinteger(l, 2);
			self.shadows=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_shadowResolution(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.LightShadowResolution)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_renderMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightRenderMode)LuaDLL.luaL_checkinteger(l, 2);
			self.renderMode=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_type(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightType)LuaDLL.luaL_checkinteger(l, 2);
			self.type=v;
			pushValue(l,true);
			return 1;
		}
