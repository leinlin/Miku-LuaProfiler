...
public class Lua_UnityEngine_ReflectionProbe : LuaObject {
	...
	static public int set_clearFlags(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.ReflectionProbeClearFlags)LuaDLL.luaL_checkinteger(l, 2);
			self.clearFlags=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_mode(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.ReflectionProbeMode)LuaDLL.luaL_checkinteger(l, 2);
			self.mode=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_refreshMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.ReflectionProbeRefreshMode)LuaDLL.luaL_checkinteger(l, 2);
			self.refreshMode=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_timeSlicingMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.Rendering.ReflectionProbeTimeSlicingMode)LuaDLL.luaL_checkinteger(l, 2);
