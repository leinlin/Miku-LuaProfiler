...
public class Lua_UnityEngine_Rigidbody2D : LuaObject {
	...
	static public int AddForce(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				a2 = (UnityEngine.ForceMode2D)LuaDLL.luaL_checkinteger(l, 3);
				self.AddForce(a1,a2);
				pushValue(l,true);
				return 1;
			}
	...
	static public int AddForceAtPosition(IntPtr l) {
		try {
			...
			if(argc==3){
				...
				a3 = (UnityEngine.ForceMode2D)LuaDLL.luaL_checkinteger(l, 4);
	...
	static public int set_bodyType(IntPtr l) {
		try {
			...
			v = (UnityEngine.RigidbodyType2D)LuaDLL.luaL_checkinteger(l, 2);
			self.bodyType=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_constraints(IntPtr l) {
		try {
			...
			v = (UnityEngine.RigidbodyConstraints2D)LuaDLL.luaL_checkinteger(l, 2);
			self.constraints=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_interpolation(IntPtr l) {
		try {
			...
			v = (UnityEngine.RigidbodyInterpolation2D)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_sleepMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.RigidbodySleepMode2D)LuaDLL.luaL_checkinteger(l, 2);
			self.sleepMode=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_collisionDetectionMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.CollisionDetectionMode2D)LuaDLL.luaL_checkinteger(l, 2);
