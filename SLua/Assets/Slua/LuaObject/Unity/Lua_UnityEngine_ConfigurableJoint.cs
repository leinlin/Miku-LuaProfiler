...
public class Lua_UnityEngine_ConfigurableJoint : LuaObject {
	...
	static public int set_xMotion(IntPtr l) {
		try {
			...
			v = (UnityEngine.ConfigurableJointMotion)LuaDLL.luaL_checkinteger(l, 2);
			self.xMotion=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public int set_rotationDriveMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.RotationDriveMode)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_projectionMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.JointProjectionMode)LuaDLL.luaL_checkinteger(l, 2);
