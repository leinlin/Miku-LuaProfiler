...
public class Lua_UnityEngine_LightProbeProxyVolume : LuaObject {
	...
	static public int set_boundingBoxMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightProbeProxyVolume.BoundingBoxMode)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_resolutionMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightProbeProxyVolume.ResolutionMode)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public int set_probePositionMode(IntPtr l) {
		try {
			...
			v = (UnityEngine.LightProbeProxyVolume.ProbePositionMode)LuaDLL.luaL_checkinteger(l, 2);
