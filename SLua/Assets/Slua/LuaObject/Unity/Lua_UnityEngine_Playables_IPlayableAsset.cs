...
public class Lua_UnityEngine_Playables_IPlayableAsset : LuaObject {
	...
	static public int CreatePlayable(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.Playables.IPlayableAsset self=(UnityEngine.Playables.IPlayableAsset)checkSelf(l);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Playables.IPlayableAsset");
		addMember(l,CreatePlayable);
		addMember(l,"duration",get_duration,null,true);
		addMember(l,"outputs",get_outputs,null,true);
		createTypeMetatable(l,null, typeof(UnityEngine.Playables.IPlayableAsset));
	}
}
