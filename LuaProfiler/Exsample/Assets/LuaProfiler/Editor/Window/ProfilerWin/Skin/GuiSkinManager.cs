        ...
        public static GUISkin TPSkin
        {
            get
            {
                if (GuiSkinManager._tpSkin == null)
                {
                    ...
                    path = "Assets" + path.Replace("\\", "/").Replace(Application.dataPath, "").Replace("GuiSkinManager.cs", "GUISkin.guiskin");
                    GuiSkinManager._tpSkin = (AssetDatabase.LoadAssetAtPath(path, typeof(GUISkin)) as GUISkin);
                }
